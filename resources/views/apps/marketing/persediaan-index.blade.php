...
<script>
    ...
    var tb_dexa = $('#tb_dexa').DataTable({
        ...
        rowCallback: function(row, data) {
            ...
            var formHtml = `
                <a href="/apps/marketing/persediaan/detail/${fc_warehousecode}"><button class="btn btn-primary btn-sm mr-1"><i class="fa fa-eye"></i> Detail</button></a>
                <form id="exportForm" action="/apps/marketing/persediaan/export-rekap" method="POST" target="_blank" style="display: inline;">
    ...
    var tb_gudanglain = $('#tb_gudanglain').DataTable({
        ...
        rowCallback: function(row, data) {
            var fc_warehousecode = window.btoa(data.fc_warehousecode);
            $('td:eq(5)', row).html(`
                <a href="/apps/marketing/persediaan-barang/detail/${fc_warehousecode}"><button class="btn btn-primary btn-sm mr-1"><i class="fa fa-eye"></i> Detail</button></a>
                <form id="exportForm" action="/apps/marketing/persediaan/export-rekap" method="POST" target="_blank" style="display: inline;">
                    <input type="hidden" name="fc_warehousecode" value="${fc_warehousecode}" >
                    <button type="submit" class="btn btn-warning btn-sm" style="display: inline;"><i class="fa-solid fa-file-excel"></i> Rekap</button>
                </form>

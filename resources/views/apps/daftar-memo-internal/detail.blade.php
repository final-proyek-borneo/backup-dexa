...
<div class="section-body">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12 col-lg-12 text-right">
                                <form id="form_cancel" action="/apps/daftar-memo-internal/cancel_so" method="PUT">
                                    @csrf
    ...
    <div class="button text-right mb-4">
        <a href="/apps/daftar-memo-internal"><button type="button" class="btn btn-info">Back</button></a>
    </div>
</div>
@endsection

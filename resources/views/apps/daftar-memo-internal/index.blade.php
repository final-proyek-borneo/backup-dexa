@extends('partial.app')
@section('title', 'Daftar Memo Internal')
@section('css')
    <style>
        .text-secondary {
...
@section('js')
    <script>
        ...
        var tb = $('#tb_semua').DataTable({
            ...
            ajax: {
                url: '/apps/daftar-memo-internal/datatables/ALL',
                type: 'GET'
            },
            columnDefs: [{
            ...
            rowCallback: function(row, data) {
                ...
                $('td:eq(10)', row).html(`
                    <a href="/apps/daftar-memo-internal/detail/${fc_sono}"><button class="btn btn-primary btn-sm mr-1"><i class="fa fa-eye"></i> Detail</button></a>
        ...
        var tb_menunggu = $('#tb_menunggu').DataTable({
            ...
            ajax: {
                url: '/apps/daftar-memo-internal/datatables/F',
                type: 'GET'
            },
            columnDefs: [{
                    className: 'text-center',
        ...
        var tb_pending = $('#tb_pending').DataTable({
            ...
            ajax: {
                url: '/apps/daftar-memo-internal/datatables/P',
                type: 'GET'
            },
            columnDefs: [{
                    className: 'text-center',
        ...
        var tb_selesai = $('#tb_selesai').DataTable({
            ...
            ajax: {
                url: '/apps/daftar-memo-internal/datatables/C',
                type: 'GET'
            },
            columnDefs: [{
                    className: 'text-center',
